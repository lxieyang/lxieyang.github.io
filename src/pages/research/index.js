...
class ResearchPage extends Component {
  ...
  render () {
    let pubsInfo = [
      ...
      {
        prompt: 'Workshops',
        data: jsonQuery('publications[*type=workshop]', {data: publicationsData}).value
      }
    ]
    ...
    return (
      <Layout pathName="Research">
        ...
        <ResearchStatementContainer>
          <p>
          <strong>Overview:</strong> I research programming support largely from a sensemaking perspective. My current work is in studying sensemaking activities in programming practices, and how sensemaking results could be effectively shared among programmers. I aim to design tools to better support programming activities, both for professional programmers and end-user programmers.
          </p>
          <p>
                      ...
                      return (
                        <Row key={pubIdx}>
                          ...
                          <Col lg='3' className="d-none d-sm-none d-md-none d-lg-block">
                            <PreviewImg src={pub.previewImgLink} alt={pub.codename} className="img-responsive"/>
                          </Col>
                          <Col lg='9'>
                            ...
                            <div className="publication-location pub-element">
                              <span className="conference">{pub.conferenceFullName}</span>, <span className="conference-year">{pub.year}</span>.
                            </div>

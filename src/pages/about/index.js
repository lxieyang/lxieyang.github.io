...
const AboutPage = () => (
    ...
    <Row>
      <Col md="9" sm="12">
        <div>
          ...
          <p>
            {' '}
            <strong> Michael Xieyang Liu </strong> is a 2nd year Ph.D. student
            at{' '}
        ...
        <div>
          ...
          <table border="0" id="edu-table">
            <tbody>
              ...
              <tr>
                <td> </td> <td> Ph.D.in Human Computer Interaction </td>{' '}
              </tr>{' '}
              <tr>
                <td> </td>{' '}
                <td>
  ...
  niki - kittur - 2 "
              ...
              <tr>
                <td> </td> <td> B.S.in Computer Science </td>{' '}
              </tr>{' '}
              <tr>
                <td> </td>{' '}
                <td>
              ...
              <tr>
                ...
                <td>
                  ...
                  <a href="http://c4e.engin.umich.edu">
                    {' '}
              ...
              <tr>
                <td> </td> <td> -Received Dean 's List (2015 - 2016)</td>{' '}
              </tr>
              <tr>
                <td> </td> <td> </td>{' '}
              </tr>{' '}
              ...
              <tr>
                <td> </td> <td> -Received Tang - Junyuan Fellowship(top 2) </td>{' '}
              </tr>{' '}
              <tr>
                <td> </td>{' '}
                <td>
                  {' '}
                  -Won Meritorious Winner prize in 2015 COMAP - The Mathematical
                  Contest in Modeling(MCM)(Acceptance: 9 % ){' '}
                </td>{' '}
              </tr>{' '}
              <tr>
                <td> </td>{' '}
        ...
        <div>
          ...
          <ul>
            ...
            <li>
              {' '}
              I love driving.I love the feeling behind the wheels.No particular
              reason, just love it.There 's also a clue about how much I love
              being on the road through this site' s{' '}
            ...
            <li>
              ...
              own{' '}
              <a href="/projects/laserguitar.html">
                {' '}
            ...
            <li>
              ...
              I love{' '}
              <a
                href="https:/ / en.wikipedia.org / wiki / 24 _(TV_series)
  "
              >
                24
              </a>{' '}
  ...
  http: //www.fox.com/prisonbreak"
              ...
              . Really can’t tell which is better. I mean Jack Bauer saves the
              world and Michael Scofield saves the family!
            </li>
            <li>
              {' '}

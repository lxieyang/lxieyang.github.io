...
const AboutPage = () => (
  <Layout pathName="About">
    <Row>
      <Col md='9' sm='12'>
        ...
        <div>
          ...
          <tbody>
            ...
            <tr>
              <td></td>
              <td>- Won Meritorious Winner prize in 2015 COMAP - The Mathematical Contest in Modeling (MCM) (Acceptance: 9%)</td>
            </tr>
            <tr>
              <td></td>
        ...
        <div>
          {/* eslint-disable-next-line */}
          <a className='anchor' name='misc'></a>
          <h2>Misc.</h2>
          ...
          <ul>
            ...
            <li>I’m a gym worm. I like the saying <a href="https://translate.google.com/#auto/en/自律给我自由">“自律给我自由”</a>. I believe regular work out is the only way towards a healthy and prosperous life.</li>
          </ul>
        </div>
      ...
      <Col md={{size: 3, offset: 8}} className="d-none d-sm-none d-md-block" style={{position: 'fixed'}}>

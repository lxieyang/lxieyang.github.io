  ...
  [230],
  {
    ...
    5532: function (e, t, n) {
            ...
            (n = [
              {
                ...
                value: function () {
                  (this.togglers = (0, g.kQ)(this.props.toggler)),
                    this.togglers.length &&
                      (this.removeEventListeners = (0, g.y_)(
                        this.togglers,
                        this.toggle,
              ...
              },
              {
                ...
                value: function () {
                  return c.createElement(
                    h.Z,
                    b({ isOpen: this.state.isOpen }, (0, g.CE)(this.props, j))
                  );
                },
              },
            ]) && v(t.prototype, n),
      ...
      var C,
        ...
        I = n.n(A),
        R = n(1452);
      const L = u.ZP.div(C || (C = (0, o.Z)(['']))),
        z = u.ZP.div(D || (D = (0, o.Z)(['\n  margin-bottom: 15px;\n']))),
        W = u.ZP.h4(M || (M = (0, o.Z)(['\n  opacity: 0.7;\n']))),
        H = u.ZP.img(
          N ||
            (N = (0, o.Z)([
        ...
        return r.createElement(
          ...
          p &&
            r.createElement(
              ...
              r.createElement(a.i, { className: 'icon' }),
              ' ',
          ...
          h &&
            r.createElement(
              'div',
              { className: 'contact-entry' },
              r.createElement(l.e, { className: 'icon' }),
              ' ',
              r.createElement(
                'a',
                {
          ...
          m &&
            r.createElement(
              'div',
              { className: 'contact-entry' },
              r.createElement(s.h, { className: 'icon' }),
              r.createElement(
                'a',
          ...
          g &&
            ...
            r.createElement(
              'div',
              { className: 'contact-entry' },
              r.createElement(c.g, { className: 'icon' }),
              ' ',
              r.createElement('a', { href: i.l5 }, 'Curriculum Vitae (PDF)')
            ),
          d &&
            r.createElement(
              'div',
          ...
          y &&
            r.createElement(
              ...
              r.createElement(u.I, { className: 'icon' }),
              r.createElement(
                'a',
                { href: i.O2, target: '_blank', rel: 'noopener noreferrer' },
                'Dissertation'
              ),
              ' '
            ),
    ...
    3576: function (e, t, n) {
      ...
      function H(e) {
        return w(e) && 'fixed' !== S(e).position ? e.offsetParent : null;
      }
      function B(e) {
        for (var t = b(e), n = H(e); n && W(n) && 'static' === S(n).position; )
          n = H(n);
        return n &&
          ('html' === D(n) || ('body' === D(n) && 'static' === S(n).position))
          ? t
          : n ||
              (function (e) {
                var t = /firefox/i.test(k());
                if (/Trident/i.test(k()) && w(e) && 'fixed' === S(e).position)
                  return null;
                var n = R(e);
                for (
                  O(n) && (n = n.host);
      ...
      var Z = 'top',
        ...
        ee = q.reduce(function (e, t) {
          return e.concat([t + '-' + Y, t + '-' + J]);
        }, []),
        te = [].concat(q, [G]).reduce(function (e, t) {
          return e.concat([t, t + '-' + Y, t + '-' + J]);
        }, []),
        ne = [
          'beforeRead',
          'read',
            ...
            u = {
              ...
              forceUpdate: function () {
                if (!c) {
                  ...
                  if (ie(t, n)) {
                    (s.rects = {
                      reference: A(t, B(n), 'fixed' === s.options.strategy),
                      popper: I(n),
                    }),
                      (s.reset = !1),
      ...
      function de(e) {
        ...
        var T,
          C = Object.assign({ position: s }, c && pe),
          D =
            !0 === u
              ? (function (e, t) {
                  var n = e.x,
                ...
                return (
                  (e[n] = (function (e, t, n) {
                    ...
                    return (
                      (a = a || 0),
                      (s = (s || 0) * o),
                      [V, F].indexOf(r) >= 0 ? { x: s, y: a } : { x: a, y: s }
                    );
                  })(n, t.rects, i)),
                  e
                );
        ...
        var o =
            'clippingParents' === t
              ? (function (e) {
                  var t = z(R(e)),
                    n =
                      ['absolute', 'fixed'].indexOf(S(e).position) >= 0 && w(e)
                        ? B(e)
                        : e;
                  return v(n)
                    ? t.filter(function (e) {
                        return v(e) && ve(e, n) && 'body' !== D(e);
                      })
                    : [];
                })(e)
              : [].concat(t),
      ...
      function ke(e, t) {
        ...
        var n = t,
          ...
          h = n.padding,
          g = void 0 === h ? 0 : h,
          y = xe('number' != typeof g ? g : je(g, q)),
          b = p === Q ? $ : Q,
          w = e.rects.popper,
          O = e.elements[m ? b : p],
          E = Ee(v(O) ? O : O.contextElement || M(e.elements.popper), l, u, a),
        ...
        if (p === Q && D) {
          ...
          Object.keys(C).forEach(function (e) {
            var t = [F, U].indexOf(e) >= 0 ? 1 : -1,
              n = [Z, U].indexOf(e) >= 0 ? 'y' : 'x';
            C[e] += N[n] * t;
          });
        }
        return C;
          ...
          if (j) {
            if (i) {
              var N,
                ...
                $ = Pe(0, k[A], J[A]),
                ee = v
                  ? k[A] / 2 - W - $ - X - C.mainAxis
                  : H - $ - X - C.mainAxis,
                te = v
                  ? -k[A] / 2 + W + $ + Q + C.mainAxis
                  : G + $ + Q + C.mainAxis,
                ...
                re = ne
                  ? 'y' === w
                    ...
                    : ne.clientLeft || 0
                  : 0,
                oe = null != (N = null == D ? void 0 : D[w]) ? N : 0,
                ie = R + te - oe,
                ae = Pe(d ? x(L, R + ee - oe - re) : L, R, d ? E(z, ie) : z);
              (j[w] = ae), (M[w] = ae - R);
            }
            if (s) {
              var se,
                ...
                ge = de - g[pe],
                ye = -1 !== [Z, V].indexOf(y),
                be = null != (se = null == D ? void 0 : D[O]) ? se : 0,
                ve = ye ? he : de - k[me] - P[me] - be + C.altAxis,
                we = ye ? de + k[me] + P[me] - be - C.altAxis : ge,
                Oe =
                  d && ye
                    ? (function (e, t, n) {
                        var r = Pe(e, t, n);
      ...
      var Ce = {
        ...
        fn: function (e) {
          var t,
            ...
            s = le(n.placement),
            l = ue(s),
            c = [V, F].indexOf(s) >= 0 ? 'height' : 'width';
          if (i && a) {
            var u = (function (e, t) {
                return xe(
                  'number' !=
      ...
      function Me(e) {
        return [Z, F, U, V].some(function (t) {
          return e[t] >= 0;
        });
      }
      var Ne = ae({
          defaultModifiers: [
            {
              ...
              effect: function (e) {
                ...
                return (
                  ...
                  s && l.addEventListener('resize', n.update, se),
                  function () {
                    i &&
                      c.forEach(function (e) {
                        e.removeEventListener('scroll', n.update, se);
                      }),
                      s && l.removeEventListener('resize', n.update, se);
                  }
                );
              },
              data: {},
            ...
            Ce,
            {
              ...
              fn: function (e) {
                var t = e.state,
                  ...
                  a = ke(t, { elementContext: 'reference' }),
      ...
      function ze(e) {
              ...
              return {
                ...
                isReferenceHidden:
                  T && T.modifiersData.hide
                    ...
                    : null,
                arrowProps: { style: C.arrow, ref: x },
                forceUpdate: D || Ie,
                update: M || Re,
              };
            },
        ...
        return ((j = f), Array.isArray(j) ? j[0] : j)(N);
      }
      var We = n(2040),
        He = n(7762),
        Be = [
      ...
      var qe = Ve(
        ...
        Ye = Ve(
          Ve({}, He.ZP.defaultProps),
          {},
          { timeout: We.wF.Fade, appear: !0, enter: !0, exit: !0, in: !0 }
        );
      function Je(e) {
        var t = (0, r.useRef)(null),
          ...
          h = void 0 === m ? t : m,
          g = Ue(n, Be),
          y = (0, We.ei)(Ve({ defaultProps: Ye }, g), We.rb),
          b = (0, We.CE)(g, We.rb);
        return r.createElement(He.ZP, Ze({ nodeRef: h }, y), function (e) {
          var t = 'entered' === e,
            n = (0, We.mx)(p()(u, s, t && c), f);
          return r.createElement(i, Ze({ className: n }, b, { ref: h }), d);
        });
      }
      Je.propTypes = qe;
      var Ke = Je;
      ...
      var ft = {
          ...
          flip: u().bool,
          container: We.qW,
          target: We.qW.isRequired,
          modifiers: u().array,
          strategy: u().string,
          boundariesElement: u().oneOfType([u().string, We.n5]),
          onClosed: u().func,
          fade: u().bool,
          transition: u().shape(Ke.propTypes),
        },
        pt = {
        ...
        dt = (function (e) {
          ...
          function a(e) {
            ...
            return (
              ...
              (t.getTargetNode = t.getTargetNode.bind(at(t))),
              (t.getRef = t.getRef.bind(at(t))),
              (t.onClosed = t.onClosed.bind(at(t))),
          ...
          return (
            ...
            (n = [
              ...
              },
              {
                ...
                value: function () {
                  return (0, We.U9)(this.props.container);
                },
              },
              {
                key: 'getRef',
              ...
              },
              {
                key: 'setTargetNode',
                value: function (e) {
                  this.targetNode = 'string' == typeof e ? (0, We.U9)(e) : e;
                },
              },
              {
                key: 'renderChildren',
                value: function () {
                  ...
                  return r.createElement(
                    Ke,
                    $e({}, P, w, { in: o, onExited: this.onClosed, tag: d }),
                    r.createElement(
                      ze,
                      {
      ...
      (dt.propTypes = ft), (dt.defaultProps = pt);
      var mt = dt;
      function ht() {
        return (
          (ht = Object.assign
      ...
      var Tt = (function (e) {
        ...
        function a(e) {
          ...
          return (
            ...
            (t.addTargetEvents = t.addTargetEvents.bind(wt(t))),
            (t.handleDocumentClick = t.handleDocumentClick.bind(wt(t))),
            (t.removeTargetEvents = t.removeTargetEvents.bind(wt(t))),
            (t.toggle = t.toggle.bind(wt(t))),
            (t.showWithDelay = t.showWithDelay.bind(wt(t))),
            (t.hideWithDelay = t.hideWithDelay.bind(wt(t))),
            ...
            (t.show = t.show.bind(wt(t))),
            (t.hide = t.hide.bind(wt(t))),
            (t.onEscKeyDown = t.onEscKeyDown.bind(wt(t))),
            (t.getRef = t.getRef.bind(wt(t))),
            (t.state = { isOpen: e.isOpen }),
            (t._isMounted = !1),
            t
          );
          ...
          (n = [
            ...
            },
            {
              ...
              value: function (e) {
                ...
                t.indexOf('legacy') > -1 &&
                (this.props.isOpen || Pt(e.target, this._targets))
                  ? (this._hideTimeout && this.clearHideTimeout(),
                    this.props.isOpen && !kt(e.target, this._popover)
                      ? this.hideWithDelay(e)
                      : this.props.isOpen || this.showWithDelay(e))
                  : t.indexOf('click') > -1 &&
                    Pt(e.target, this._targets) &&
                    (this._hideTimeout && this.clearHideTimeout(),
                    this.props.isOpen
                      ? this.hideWithDelay(e)
            ...
            },
            {
              ...
              value: function (e) {
                ...
                return 'object' === gt(t) ? (isNaN(t[e]) ? xt[e] : t[e]) : t;
              },
            },
            {
            ...
            },
            {
              key: 'updateTarget',
              value: function () {
                var e = (0, We.U9)(this.props.target, !0);
                e !== this._targets &&
                  (this.removeTargetEvents(),
            ...
            },
            {
              ...
              value: function () {
                ...
                var n = this.props,
                  ...
                  v = n.flip,
                  w = n.children,
                  O = (0, We.CE)(this.props, Object.keys(Et)),
                  E = (0, We.mx)(d, i),
                  x = (0, We.mx)(a, i);
                return r.createElement(
                  mt,
      ...
      (Tt.propTypes = Et), (Tt.defaultProps = jt);
      var Ct = Tt;
      function Dt() {
        return (
          (Dt = Object.assign
      ...
      Ut.propTypes = (function (e) {
        ...
        return e;
      })({ defaultOpen: u().bool }, St.propTypes);
      var Ft = (e) => {
        ...
        Gt = n.p + 'static/nikikittur-50bb2cca4c2f1957b52960e192bfab2b.jpg',
        qt = n(5532);
      const Yt = (e) => {
            ...
            r.createElement(
              ...
              r.createElement(
                ...
                r.createElement(
                  ...
                  ' ',
                  '(People + AI Research Initiative) team. His research aims to improve human-AI interaction, with a particular focus on human interaction with multimodal large language models and controllable AI.'
                ),
                r.createElement(
                  'p',
                  null,
                ...
                r.createElement(
                  'p',
                  null,
                  'He publishes at premier HCI academic venues such as CHI, UIST, and CSCW, VIS, including three award-winning papers: a',
                  ' ',
                  r.createElement(
                    'strong',
                    null,
                  ...
                  ' at CHI 2023, a',
                  ' ',
                  r.createElement('strong', null, 'best paper'),
                  ' at CSCW 2021, and a',
                  ' ',
                  r.createElement(
                    'strong',
                  ...
                  ' at UIST 2019. His work has been generously supported by the',
                  ' ',
                  r.createElement(
                    'a',
                    {
...
//# sourceMappingURL=component---src-pages-index-jsx-110f028850a4c523b8b9.js.map

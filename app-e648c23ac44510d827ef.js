/*! For license information please see app-e648c23ac44510d827ef.js.LICENSE.txt */
  ...
  [143],
  {
    ...
    5418: function (t, e, n) {
      e.components = {
        ...
        'component---src-pages-404-jsx': () =>
          Promise.all([n.e(532), n.e(813), n.e(256)]).then(n.bind(n, 6197)),
        'component---src-pages-backtowork-index-jsx': () =>
          Promise.all([n.e(532), n.e(159)]).then(n.bind(n, 2767)),
        'component---src-pages-cv-index-jsx': () =>
          Promise.all([n.e(532), n.e(813), n.e(562), n.e(671)]).then(
            n.bind(n, 2821)
          ),
        'component---src-pages-index-jsx': () =>
          Promise.all([n.e(532), n.e(813), n.e(562), n.e(230)]).then(
            n.bind(n, 3576)
          ),
        'component---src-pages-research-index-jsx': () =>
          Promise.all([n.e(532), n.e(813), n.e(562), n.e(445)]).then(
            n.bind(n, 2346)
          ),
        'component---src-pages-xuexuemaimai-index-jsx': () =>
          Promise.all([n.e(532), n.e(561)]).then(n.bind(n, 7205)),
      };
    },
    4741: function (t, e, n) {
      t.exports = [
    ...
    4854: function (t, e, n) {
      ...
      const y = (t) => {
          ...
          const r = [
            d.createElement('slice-start', { id: e + '-1' }),
            d.createElement('slice-end', { id: e + '-1' }),
          ];
          return (
            n &&
              (r.push(n),
              r.push(
                d.createElement('slice-start', { id: e + '-2' }),
                d.createElement('slice-end', { id: e + '-2' })
              )),
            r
          );
        },
        ...
        w = (t) => {
          let { sliceName: e, allowEmpty: n, children: r } = t,
            o = (0, m.Z)(t, b);
          const a = (0, d.useContext)(v.u0),
            i = (0, d.useContext)(v.Db),
            s = a[e];
          if (!s) {
            if (n) return null;
          ...
          const c = ((t, e) =>
            Object.keys(e).length ? t + '-' + (0, g.M)(e) : t)(s, o);
          let u = i[c];
          return (
            u
              ? r && (u.hasChildren = !0)
      ...
      function S(t) {
        {
          ...
          if ('browser' === r.renderEnvironment) return d.createElement(_, n);
          if (
    ...
    1975: function (t, e, n) {
      ...
      let y = (function () {
        ...
        return (
              ...
              if (200 === o)
                try {
                  ...
                  return (
                    ...
                    Object.assign(t, { status: p.Success, payload: n })
                  );
                } catch (i) {}
              return 404 === o || 200 === o
          ...
          (e.fetchPartialHydrationJson = function (t) {
            const { pagePath: e, retries: n = 0 } = t,
              r = f(e).replace('.json', '-rsc.json');
            return this.memoizedGet(r).then((r) => {
              const { status: o, responseText: a } = r;
              if (200 === o)
                try {
                  return Object.assign(t, { status: p.Success, payload: a });
                } catch (i) {}
              return 404 === o || 200 === o
                ? '/404.html' === e || '/500.html' === e
                  ? Object.assign(t, { status: p.Error })
          ...
          (e.loadPage = function (t) {
            ...
            const n = [this.loadAppData(), this.loadPageDataJson(e)];
            const r = Promise.all(n).then((t) => {
              const [n, r, i] = t;
              if (
                r.status === p.Error ||
              ...
              return Promise.all(d.map((t) => this.loadSliceDataJson(t))).then(
                (t) => {
                  const f = [],
                    d = (0, o.Z)(l);
                  ...
                  const b = Promise.all(y).then((t) => {
                      ...
                      if (
                        ...
                        if (
                          ...
                          return v((0, a.createFromReadableStream)(t)).then(
                            (t) => ((u.partialHydration = t), u)
                          );
                        }
                        u = g(s, c, o);
                      }
                  ...
                  return Promise.all([b, w])
                    ...
                    .catch((t) => ({ error: t, status: p.Error }));
                }
              );
            });
            return (
          ...
          (e.getResourceURLsForPathname = function (t) {
            ...
            if (n) {
              const t = g(n.payload);
              return [].concat((0, o.Z)(b(t.page.componentChunkName)), [f(e)]);
            }
            return null;
          }),
      ...
      const b = (t) => (window.___chunkMapping[t] || []).map((t) => '' + t);
      let w,
        E = (function (t) {
          function e(e, n, r) {
            var o;
            ...
            (n.doPrefetch = function (e) {
              return t.prototype.doPrefetch.call(this, e).then((t) => {
                ...
                const e = t.payload,
                  ...
                  r = b(n);
                return Promise.all(r.map(c)).then(() => e);
              });
            }),
      ...
      const _ = (t) => {
        ...
        S = {
          enqueue: (t) => w.prefetch(t),
          getResourceURLsForPathname: (t) => w.getResourceURLsForPathname(t),
          loadPage: (t) => w.loadPage(t),
          loadPageSync: function (t, e) {
            return void 0 === e && (e = {}), w.loadPageSync(t, e);
          },
          prefetch: (t) => w.prefetch(t),
          isPageNotFound: (t) => w.isPageNotFound(t),
          hovering: (t) => w.hovering(t),
    ...
    4779: function (t, e, n) {
            ...
            if (v(t))
              if ('html' === t || 'body' === t)
                ...
                if (
                  ...
                  'script' === t.nodeName.toLowerCase() && (t = g(t)),
                  l)
                )
                  if (n.has(l)) {
                    var s;
                    const e = n.get(l);
                    null === (s = r[e].parentNode) ||
                      void 0 === s ||
                      s.removeChild(r[e]),
                      (r[e] = t);
                  } else r.push(t), n.set(l, r.length - 1);
                else r.push(t);
              }
            u.childNodes.length &&
              r.push.apply(r, (0, c.Z)(m(u, e).validHeadNodes));
          }
        }
      ...
      const b = document.createElement('div'),
        ...
        E = () => {
          var t;
          const { validHeadNodes: e, htmlAndBodyAttributes: n } = m(b);
          ...
          var o;
          if (0 === r.length)
            return void (o = document.head).append.apply(o, (0, c.Z)(e));
          const a = [];
          !(function (t) {
            let { oldNodes: e, newNodes: n, onStale: r, onNew: o } = t;
            for (const a of e) {
              const t = n.findIndex((t) => d(t, a));
        ...
        (0, r.useEffect)(() => {
          if (null != e && e.Head) {
            ...
            const { render: a } = (0, p.U)(),
              ...
              c = (0, i.h)('wrapRootElement', { element: s }, s, (t) => {
                let { result: e } = t;
                return { element: e };
              }).pop();
            a(
      ...
      function S(t) {
        ...
        return (0, i.h)('wrapPageElement', { element: n, props: e }, n, (t) => {
          let { result: n } = t;
    ...
    5824: function (t, e, n) {
      ...
      const v = (t, e) => {
        ...
        b = function (t, e) {
          ...
          const { pathname: n, search: r, hash: a } = (0, d.cP)(t),
            s = (0, p.J)(n);
      ...
      const { render: D, hydrate: T } = (0, k.U)();
      ...
      (0, o.I)('onClientEntry').then(() => {
          ...
          h = (function (n) {
            ...
            return (
              ...
              (o.prototype.render = function () {
                return a.createElement(e.Consumer, null, (e) => {
        ...
        d &&
          ...
          (0, i.navigate)('' + d + (d.includes('?') ? '' : m.search) + m.hash, {
            replace: !0,
          });
        const g = () => {
          try {
        ...
        l.jN.loadPage(m.pathname + m.search).then((t) => {
          var e;
          const n = g();
          if (
            null != t &&
    ...
    9730: function (t, e, n) {
      ...
      function l(t, e, n) {
        (this._status = t), (this._value = e), (this._response = n);
      }
      function p(t) {
        switch (t._status) {
          case 3:
            return t._value;
          case 1:
            var e = JSON.parse(t._value, t._response._fromJSON);
            return (t._status = 3), (t._value = e);
          case 2:
            for (var r = (e = t._value).chunks, o = 0; o < r.length; o++) {
              var i = a.get(r[o]);
              if (null !== i) throw i;
            }
            return (
      ...
      function v(t, e) {
        var n = t._chunks,
          r = n.get(e);
        return r || ((r = new l(0, null, t)), n.set(e, r)), r;
      }
      function y(t) {
        g(t, Error('Connection closed.'));
      }
      function b(t, e) {
        if ('' !== e) {
          var o = e[0],
            i = e.indexOf(':', 1),
            s = parseInt(e.substring(1, i), 16);
          switch (((i = e.substring(i + 1)), o)) {
            case 'J':
              (o = (e = t._chunks).get(s))
                ? 0 === o._status &&
                  ((t = o._value), (o._status = 1), (o._value = i), d(t))
                : e.set(s, new l(1, i, t));
              break;
            case 'M':
              (o = (e = t._chunks).get(s)), (i = JSON.parse(i, t._fromJSON));
              var p = t._bundlerConfig;
              ...
              o
                ? 0 === o._status &&
                  ((t = o._value), (o._status = 2), (o._value = i), d(t))
                : e.set(s, new l(2, i, t));
              break;
            case 'P':
              t._chunks.set(
                ...
                h(
                  t,
                  (function (t) {
                    return u[t] || (u[t] = r.createServerContext(t, c)), u[t];
                  })(i).Provider
                )
              );
              break;
            case 'S':
              (o = JSON.parse(i)), t._chunks.set(s, h(t, Symbol.for(o)));
              break;
            case 'E':
              (e = JSON.parse(i)),
                ((o = Error(e.message)).stack = e.stack),
                (i = (e = t._chunks).get(s))
                  ? m(i, o)
                  : e.set(s, new l(4, o, t));
              break;
                ...
                switch (n[0]) {
                  case '$':
                    return '$' === n
                      ...
                      : '$' === n[1] || '@' === n[1]
                      ? n.substring(1)
                      : p((t = v(t, parseInt(n.substring(1), 16))));
                  case '@':
                    return (
                      (t = v(t, parseInt(n.substring(1), 16))),
                      { $$typeof: s, _payload: t, _init: p }
                    );
                }
                return n;
              })(t, 0, n)
      ...
      function _(t, e) {
        ...
        var r = e.getReader();
        r.read().then(function e(a) {
          var i = a.value;
          if (!a.done) {
            (a = i), (i = t._stringDecoder);
            ...
            return (t._partialRow += i.decode(a, o)), r.read().then(e, n);
          }
          y(t);
        }, n);
      }
      (l.prototype.then = function (t) {
        0 === this._status
          ? (null === this._value && (this._value = []), this._value.push(t))
          : t();
      }),
        (e.createFromReadableStream = function (t, e) {
          return _((e = E(e && e.moduleMap ? e.moduleMap : null)), t), e;
        });
    },
    904: function (t, e, n) {
      'use strict';
    ...
    7896: function (t, e, n) {
      ...
      function S(t) {
        ...
        o.useEffect(() => {
          Promise.resolve().then(() => {
            const o = O(e, i);
            d(k(o, t), { replace: n, state: r });
          });
        }, []);
        const s = O(e, i);
        return a || _(k(s, t)), null;
      }
      const P = (t) => {
        const e = b(),
          { baseuri: n } = y();
        return o.createElement(S, s({}, e, { baseuri: n }, t));
      };
      ...
      const R = (t, e) => t.substr(0, e.length) === e,
        ...
        j = (t, e) => {
          const n = (t) => T(t);
          return (
            A(t).filter(n).sort().join('/') === A(e).filter(n).sort().join('/')
          );
        },
        D = /^:(.+)/,
        T = (t) => D.test(t),
        ...
        q = (t) => (e) => {
          ...
          const n = e.type === P ? e.props.from : e.props.path,
            r = '/' === n ? t : `${W(t)}/${W(n)}`;
          return {
            value: e,
      ...
      const z = (function (t) {
        ...
        X = ({ children: t }) => {
          const e = b();
          return e ? t(e) : o.createElement(z, null, t);
        },
        Y = ({ url: t, children: e }) => {
          const n = t.indexOf('?');
          let r,
      ...
      const at = (t) => {
            ...
            o.useEffect(() => {
              ...
              a !== f.current && ((f.current = a), (t = !0)),
                i.pathname !== h.current &&
                  ((h.current = i.pathname), (e = !0)),
                (d.current = t || (e && i.pathname === a)),
                d.current && m();
            }, [a, i]);
          const m = o.useCallback(() => {
            ...
            p.current
              ? (p.current = !1)
              : ((t = l.current), d.current && t && t.focus());
          }, []);
          return o.createElement(
            r,
                    ...
                    onClick: (t) => {
                      if (
                        ...
                        'boolean' != typeof p && n && (e = !0),
                          window.___navigate(d, { state: u, replace: e });
                      }
                      return !0;
                    },
                  },
    ...
    3521: function (t, e, n) {
      ...
      function g(t) {
        ...
        if (s) {
          for (const t of c) {
            const e = (e) => w(e, s, t);
            E.addEventListener(t, e), (_[`${t}Callback`] = e);
          }
          f.add(s);
        }
        return (
...
//# sourceMappingURL=app-e648c23ac44510d827ef.js.map

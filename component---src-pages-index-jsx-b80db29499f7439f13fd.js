  ...
  [279],
  {
    ...
    1337: function (e, t, n) {
      ...
      var r = n(6540),
        ...
        a = n(1819),
        s = n(6054),
        l = n.p + 'static/lxieyang-avatar-39bbdc47100555312a676a5d327610b1.png',
        c = n(5556),
        u = n.n(c),
        f = n(2485),
        p = n.n(f),
      ...
      function T(e, t, n) {
        ...
        var a = (v(e) ? b(e) : window).visualViewport,
          s = !P() && n,
      ...
      function C(e) {
        return T(M(e)).left + N(e).scrollLeft;
      }
      function A(e) {
      ...
      function R(e) {
        return 'html' === D(e)
          ? e
          : e.assignedSlot || e.parentNode || (O(e) ? e.host : null) || M(e);
      }
      function L(e) {
      ...
      function B(e) {
        for (var t = b(e), n = H(e); n && W(n) && 'static' === A(n).position; )
          n = H(n);
        return n &&
          ('html' === D(n) || ('body' === D(n) && 'static' === A(n).position))
          ? t
          : n ||
              (function (e) {
                var t = /firefox/i.test(k());
                if (/Trident/i.test(k()) && w(e) && 'fixed' === A(e).position)
                  return null;
                var n = R(e);
                for (
                  O(n) && (n = n.host);
      ...
      var U = 'top',
        ...
        Y = 'viewport',
        K = 'popper',
        X = Z.reduce(function (e, t) {
          return e.concat([t + '-' + J, t + '-' + Q]);
        }, []),
        $ = [].concat(Z, [q]).reduce(function (e, t) {
          return e.concat([t, t + '-' + J, t + '-' + Q]);
        }, []),
        ee = [
          'beforeRead',
          'read',
            ...
            u = {
              ...
              forceUpdate: function () {
                if (!c) {
                  ...
                  if (re(t, n)) {
                    (s.rects = {
                      reference: _(t, B(n), 'fixed' === s.options.strategy),
                      popper: I(n),
                    }),
                      (s.reset = !1),
      ...
      function fe(e) {
        var t,
          ...
          m = a.y,
          h = void 0 === m ? 0 : m,
          g = 'function' == typeof u ? u({ x: d, y: h }) : { x: d, y: h };
        (d = g.x), (h = g.y);
        ...
        var T,
          N = Object.assign({ position: s }, c && ue),
          D =
            !0 === u
              ? (function (e, t) {
                  var n = e.x,
                ...
                return (
                  (e[n] = (function (e, t, n) {
                    ...
                    return (
                      (a = a || 0),
                      (s = (s || 0) * o),
                      [G, F].indexOf(r) >= 0 ? { x: s, y: a } : { x: a, y: s }
                    );
                  })(n, t.rects, i)),
                  e
                );
        ...
        return t === Y
          ? be(
              (function (e, t) {
                ...
                return { width: i, height: a, x: s + C(e), y: l };
              })(e, n)
            )
          : v(t)
          ? (function (e, t) {
          ...
          : be(
              (function (e) {
                ...
                return (
                  'rtl' === A(o || n).direction &&
                    (s += E(n.clientWidth, o ? o.clientWidth : 0) - i),
        ...
        var o =
            'clippingParents' === t
              ? (function (e) {
                  var t = z(R(e)),
                    n =
                      ['absolute', 'fixed'].indexOf(A(e).position) >= 0 && w(e)
                        ? B(e)
                        : e;
                  return v(n)
                    ? t.filter(function (e) {
                        return v(e) && ye(e, n) && 'body' !== D(e);
                      })
                    : [];
                })(e)
              : [].concat(t),
          ...
          s = i.reduce(function (t, n) {
            ...
            return (
              (t.top = E(o.top, t.top)),
              (t.right = x(o.right, t.right)),
              (t.bottom = x(o.bottom, t.bottom)),
      ...
      function xe(e, t) {
        ...
        var n = t,
          ...
          h = n.padding,
          g = void 0 === h ? 0 : h,
          y = Oe('number' != typeof g ? g : Ee(g, Z)),
          b = p === K ? 'reference' : K,
          w = e.rects.popper,
          O = e.elements[m ? b : p],
          E = we(v(O) ? O : O.contextElement || M(e.elements.popper), l, u, a),
          ...
          if (j) {
            if (i) {
              var C,
                ...
                $ = je(0, k[_], Q[_]),
                ee = v
                  ? k[_] / 2 - W - $ - K - N.mainAxis
                  : H - $ - K - N.mainAxis,
                te = v
                  ? -k[_] / 2 + W + $ + X + N.mainAxis
                  : q + $ + X + N.mainAxis,
                ...
                re = ne
                  ? 'y' === w
                    ...
                    : ne.clientLeft || 0
                  : 0,
                oe = null != (C = null == D ? void 0 : D[w]) ? C : 0,
                ie = R + te - oe,
                ce = je(d ? x(L, R + ee - oe - re) : L, R, d ? E(z, ie) : z);
              (j[w] = ce), (M[w] = ce - R);
            }
            if (s) {
              var ue,
                ...
                ge = de - g[pe],
                ye = -1 !== [U, G].indexOf(y),
                be = null != (ue = null == D ? void 0 : D[O]) ? ue : 0,
                ve = ye ? he : de - k[me] - P[me] - be + N.altAxis,
                we = ye ? de + k[me] + P[me] - be - N.altAxis : ge,
                Oe =
                  d && ye
                    ? (function (e, t, n) {
                        var r = je(e, t, n);
      ...
      var Pe = {
        ...
        fn: function (e) {
          var t,
            ...
            s = ae(n.placement),
            l = le(s),
            c = [G, F].indexOf(s) >= 0 ? 'height' : 'width';
          if (i && a) {
            var u = (function (e, t) {
                return Oe(
                  'number' !=
      ...
      function Ne(e) {
        return [U, F, V, G].some(function (t) {
          return e[t] >= 0;
        });
      }
      var De = oe({
          defaultModifiers: [
            {
              ...
              effect: function (e) {
                ...
                return (
                  ...
                  s && l.addEventListener('resize', n.update, ie),
                  function () {
                    i &&
                      c.forEach(function (e) {
                        e.removeEventListener('scroll', n.update, ie);
                      }),
                      s && l.removeEventListener('resize', n.update, ie);
                  }
                );
              },
              data: {},
      ...
      function Re(e) {
              ...
              return {
                ...
                isReferenceHidden:
                  T && T.modifiersData.hide
                    ...
                    : null,
                arrowProps: { style: N.arrow, ref: x },
                forceUpdate: D || Se,
                update: M || _e,
              };
            },
        ...
        return ((j = f), Array.isArray(j) ? j[0] : j)(C);
      }
      var Le = n(6331),
        ze = n(3674),
        We = [
      ...
      var Ge = Ve(
          ...
          {},
          {
            ...
            tag: Le.Wx,
            baseClass: u().string,
            baseClassActive: u().string,
            className: u().string,
            cssModule: u().object,
            innerRef: u().oneOfType([u().object, u().string, u().func]),
          }
        ),
        qe = Ve(
          Ve({}, ze.Ay.defaultProps),
          {},
          { timeout: Le.Q6.Fade, appear: !0, enter: !0, exit: !0, in: !0 }
        );
      function Ze(e) {
        var t = (0, r.useRef)(null),
          ...
          h = void 0 === m ? t : m,
          g = Be(n, We),
          y = (0, Le.Up)(Ve({ defaultProps: qe }, g), Le.PS),
          b = (0, Le.cJ)(g, Le.PS);
        return r.createElement(ze.Ay, He({ nodeRef: h }, y), function (e) {
          var t = 'entered' === e,
            n = (0, Le.qO)(p()(u, s, t && c), f);
          return r.createElement(i, He({ className: n }, b, { ref: h }), d);
        });
      }
      Ze.propTypes = Ge;
      var Je = Ze;
      ...
      var ct = {
          children: u().oneOfType([u().node, u().func]).isRequired,
          ...
          isOpen: u().bool,
          cssModule: u().object,
          offset: u().arrayOf(u().number),
          fallbackPlacements: u().array,
          flip: u().bool,
          container: Le.xQ,
          target: Le.xQ.isRequired,
          modifiers: u().array,
          strategy: u().string,
          boundariesElement: u().oneOfType([u().string, Le.to]),
          onClosed: u().func,
          fade: u().bool,
          transition: u().shape(Je.propTypes),
        },
        ut = {
        ...
        ft = (function (e) {
          ...
          function a(e) {
            ...
            return (
              ...
              (t.getTargetNode = t.getTargetNode.bind(ot(t))),
              (t.getRef = t.getRef.bind(ot(t))),
              (t.onClosed = t.onClosed.bind(ot(t))),
          ...
          return (
            ...
            (n = [
              ...
              },
              {
                ...
                value: function () {
                  return (0, Le.EW)(this.props.container);
                },
              },
              {
                key: 'getRef',
              ...
              },
              {
                key: 'setTargetNode',
                value: function (e) {
                  this.targetNode = 'string' == typeof e ? (0, Le.EW)(e) : e;
                },
              },
              {
                key: 'renderChildren',
                value: function () {
                  var e = this.props,
                    ...
                    j = [
                      ...
                      return !x.includes(e.name);
                    }),
                    k = [].concat(Xe(j), Xe(m)),
                    P = st(
                      st(st({}, Je.defaultProps), b),
                      {},
                      {
                  ...
                  return r.createElement(
                    Je,
                    Ke({}, P, w, { in: o, onExited: this.onClosed, tag: d }),
                    r.createElement(
                      Re,
                      {
                      ...
                      function (e) {
                        ...
                        return r.createElement(
                          ...
                          'function' == typeof n ? n({ update: l }) : n,
                          !u &&
      ...
      (ft.propTypes = ct), (ft.defaultProps = ut);
      var pt = ft;
      function dt() {
        return (
          (dt = Object.assign
      ...
      var kt = (function (e) {
        ...
        function a(e) {
          ...
          return (
            ...
            (t.addTargetEvents = t.addTargetEvents.bind(bt(t))),
            (t.handleDocumentClick = t.handleDocumentClick.bind(bt(t))),
            (t.removeTargetEvents = t.removeTargetEvents.bind(bt(t))),
            (t.toggle = t.toggle.bind(bt(t))),
            (t.showWithDelay = t.showWithDelay.bind(bt(t))),
            (t.hideWithDelay = t.hideWithDelay.bind(bt(t))),
            ...
            (t.show = t.show.bind(bt(t))),
            (t.hide = t.hide.bind(bt(t))),
            (t.onEscKeyDown = t.onEscKeyDown.bind(bt(t))),
            (t.getRef = t.getRef.bind(bt(t))),
            (t.state = { isOpen: e.isOpen }),
            (t._isMounted = !1),
            t
          );
          ...
          (n = [
            ...
            },
            {
              ...
              value: function (e) {
                ...
                t.indexOf('legacy') > -1 &&
                (this.props.isOpen || jt(e.target, this._targets))
                  ? (this._hideTimeout && this.clearHideTimeout(),
                    this.props.isOpen && !xt(e.target, this._popover)
                      ? this.hideWithDelay(e)
                      : this.props.isOpen || this.showWithDelay(e))
                  : t.indexOf('click') > -1 &&
                    jt(e.target, this._targets) &&
                    (this._hideTimeout && this.clearHideTimeout(),
                    this.props.isOpen
                      ? this.hideWithDelay(e)
            ...
            },
            {
              ...
              value: function (e) {
                ...
                return 'object' === mt(t) ? (isNaN(t[e]) ? Ot[e] : t[e]) : t;
              },
            },
            {
            ...
            },
            {
              key: 'updateTarget',
              value: function () {
                var e = (0, Le.EW)(this.props.target, !0);
                e !== this._targets &&
                  (this.removeTargetEvents(),
            ...
            },
            {
              ...
              value: function () {
                ...
                var n = this.props,
                  ...
                  v = n.flip,
                  w = n.children,
                  O = (0, Le.cJ)(this.props, Object.keys(wt)),
                  E = (0, Le.qO)(d, i),
                  x = (0, Le.qO)(a, i);
                return r.createElement(
                  pt,
      ...
      (kt.propTypes = wt), (kt.defaultProps = Et);
      var Pt = kt;
      function Tt() {
        return (
          (Tt = Object.assign
      ...
      function Dt(e) {
        var t = p()('tooltip-arrow', e.arrowClassName),
          n = p()('tooltip', 'show', e.popperClassName),
          o = p()('tooltip-inner', e.innerClassName),
          i = (0, Le.Jc)(Nt, e);
        return r.createElement(
          Pt,
          Tt({}, i, {
        ...
        Bt = (function (e) {
          ...
          function a(e) {
            ...
            return (
              ...
              ((t = i.call(this, e)).state = { isOpen: e.defaultOpen || !1 }),
              (t.toggle = t.toggle.bind(zt(t))),
              t
            );
          }
          return (
      ...
      Bt.propTypes = (function (e) {
        ...
        return e;
      })({ defaultOpen: u().bool }, Mt.propTypes);
      var Ut = (e) => {
          let { target: t, headshotPath: n } = e;
          return r.createElement(
            Bt,
            {
              placement: 'bottom',
            ...
            r.createElement('img', { alt: t, src: n, style: { width: '100%' } })
          );
        },
        Vt = n.p + 'static/bradmyers-29079073a9197733a988f1f490ad8f23.jpg',
        Ft = n.p + 'static/nikikittur-50bb2cca4c2f1957b52960e192bfab2b.jpg',
        Gt = n(4723);
      const qt = (e) => {
        ...
        return r.createElement(
          ...
          r.createElement(
            'title',
            null,
            ('/' !== o ? o : 'Home') + ' | ' + n.site.siteMetadata.title
          ),
          ...
          r.createElement('meta', {
            name: 'keywords',
            content:
              'Google Research, Human-AI Interaction, Computer Science, Research Scientist',
          })
        );
      };
      var Zt = (e) => {
        ...
        return r.createElement(
          ...
          r.createElement(
              ...
              r.createElement(
                ...
                r.createElement(
                  ...
                  r.createElement(
                    ...
                    r.createElement(
                      'div',
                      { className: 'watermark-image-display-container' },
                      r.createElement('img', { src: l, alt: 'profile' }),
                  ...
                  r.createElement(
                    ...
                    r.createElement(
                      ...
                      t.site.siteMetadata.nameEnglish
                    ),
                    r.createElement(
                      'p',
            ...
            r.createElement(
              ...
              r.createElement(
                'div',
                { className: 'homepage-word-section' },
                r.createElement('br', null),
                r.createElement(
                  'p',
                  null,
                  'Michael Xieyang Liu is a Senior Research Scientist at Google DeepMind in the',
                  ' ',
                  r.createElement(
                    'a',
                    {
                  ...
                  ' ',
                  r.createElement('strong', null, 'human-AI interaction'),
                  ' for large and multimodal language models, including tools for',
                  ' ',
                  r.createElement('strong', null, 'LLM evaluation'),
                  ',',
                  ' ',
                  r.createElement('strong', null, 'controllable generation'),
                  ', and',
                  ' ',
                  r.createElement('strong', null, 'in situ AI prototyping'),
                  '. He combines human-centered research with system building, developing tools and studies that help people use AI more effectively in real workflows — from ',
                  r.createElement(
                    'a',
                    { href: '#llm-constraints-2024' },
                  ...
                  r.createElement(
                    'a',
                    { href: '#gensors-iui-2025' },
                    'personalized visual sensors'
                  ),
                  ',',
                  ' ',
                  r.createElement(
                    'a',
                    { href: '#llmcomparator-vis-2024' },
                    'side-by-side model evaluation'
                  ),
                  ', ',
                  r.createElement(
                    'a',
                    { href: '#adcanvas-chi-2026' },
                ...
                r.createElement(
                  ...
                  r.createElement(
                    'a',
                    { href: 'https://www.hcii.cmu.edu', rel: 'noreferrer' },
                  ...
                  r.createElement(
                    'a',
                    { href: 'https://www.cmu.edu', rel: 'noreferrer' },
                  ...
                  ',',
                  ' ',
                  r.createElement('strong', null, 'Programming Support Tools'),
                  ',',
                  ' ',
                  r.createElement('strong', null, 'Sensemaking'),
                  ',',
                  ' ',
                  r.createElement('strong', null, 'End-user Programming'),
                  ', and',
                  ' ',
                  r.createElement(
                    'strong',
                  ...
                  ', using human-centered methods to design, build, and study interactive systems that help people, especially developers, find, collect, organize, and make sense of information online. He also interned at the',
                  ' ',
                  r.createElement(
                    'a',
                    {
                  ...
                  ' ',
                  'group at Microsoft Research, the Google Cloud team at Google, and Bosch Research.'
                ),
                r.createElement(
                  'p',
                  null,
                  'He publishes at premier HCI academic venues such as CHI, UIST, and CSCW, VIS, including three award-winning papers. His PhD work was generously supported by the',
                  ' ',
                  r.createElement(
                    'a',
                    {
                ...
                r.createElement(Gt.A, null),
                r.createElement('hr', null),
                r.createElement('br', null),
                r.createElement('h1', null, 'Selected Open-source projects'),
                r.createElement(
                  'ul',
                  null,
                  r.createElement(
                    ...
                    r.createElement(
                      ...
                      r.createElement('img', {
                        ...
                        src: 'https://img.shields.io/chrome-web-store/v/pddljdmihkpdfpkgmbhdomeeifpklgnm',
                      }),
                      '   ',
                      r.createElement('img', {
                        alt: 'user-count',
                        src: 'https://img.shields.io/chrome-web-store/users/pddljdmihkpdfpkgmbhdomeeifpklgnm',
                      }),
                      '   ',
                      r.createElement('img', {
                        alt: 'last-commit',
                        src: 'https://img.shields.io/github/last-commit/lxieyang/vertical-tabs-chrome-extension',
                      }),
                      '   ',
                      r.createElement('img', {
                        alt: 'star-count',
                        src: 'https://img.shields.io/github/stars/lxieyang/vertical-tabs-chrome-extension?style=social',
                      }),
                      '   ',
                      r.createElement(
                        'a',
                  ...
                  r.createElement(
                    ...
                    r.createElement(
                      ...
                      r.createElement('img', {
                        alt: 'fork-count',
                        src: 'https://img.shields.io/github/forks/lxieyang/chrome-extension-boilerplate-react',
                      }),
                      '   ',
                      r.createElement('img', {
                        alt: 'npm-version',
                        src: 'https://img.shields.io/npm/v/chrome-extension-boilerplate-react',
                      }),
                      '   ',
                      r.createElement('img', {
                        alt: 'npm-download-week',
                        src: 'https://img.shields.io/npm/dw/chrome-extension-boilerplate-react',
                      }),
                      '   ',
                      r.createElement('img', {
                        alt: 'npm-download-month',
                        src: 'https://img.shields.io/npm/dm/chrome-extension-boilerplate-react',
                      }),
                      '   ',
                      r.createElement('img', {
                        alt: 'star-count',
                        src: 'https://img.shields.io/github/stars/lxieyang/chrome-extension-boilerplate-react?style=social',
                      }),
                      '   ',
                      r.createElement(
                        'a',
    ...
    4723: function (e, t, n) {
      ...
      var j = ['toggleEvents', 'defaultOpen'],
        k = {
          defaultOpen: m().bool,
          toggler: m().string.isRequired,
          toggleEvents: m().arrayOf(m().string),
        },
        P = { toggleEvents: g.Jb },
        T = (function (e) {
          !(function (e, t) {
          ...
          function i(e) {
            ...
            return (
              ...
              ((t = o.call(this, e)).togglers = null),
              (t.removeEventListeners = null),
              (t.toggle = t.toggle.bind(E(t))),
            ...
            (n = [
              {
                key: 'componentDidMount',
                value: function () {
                  (this.togglers = (0, g.Tu)(this.props.toggler)),
                    this.togglers.length &&
                      (this.removeEventListeners = (0, g.vL)(
                        this.togglers,
                        this.toggle,
              ...
              },
              {
                ...
                value: function () {
                  return c.createElement(
                    h.A,
                    b({ isOpen: this.state.isOpen }, (0, g.cJ)(this.props, j))
                  );
                },
              },
            ]) && v(t.prototype, n),
      ...
      (T.propTypes = k), (T.defaultProps = P);
      var N,
        D,
        M,
        C,
        ...
        I = n.n(_),
        R = n(9662);
      const L = u.Ay.div(N || (N = (0, o.A)(['']))),
        z = u.Ay.div(D || (D = (0, o.A)(['\n  margin-bottom: 15px;\n']))),
        W = u.Ay.h4(M || (M = (0, o.A)(['\n  opacity: 0.7;\n']))),
        H = u.Ay.img(
          C ||
            (C = (0, o.A)([
            ...
            let e = [
              {
                ...
                data: I()('publications[*type=conference]', {
                  data: R.u,
                }).value.filter((e) => !1 !== e.showInResearchPage),
              },
              {
                prompt: 'Workshop Papers & Posters',
                data: I()('publications[*type=workshop]', {
                  data: R.u,
                }).value.filter((e) => !1 !== e.showInResearchPage),
              },
            ];
              ...
              c.createElement(
                ...
                e.map((e, t) =>
                  c.createElement(
                    z,
                    { key: t },
                    c.createElement(W, null, e.prompt),
                    a()(l()(e.data, ['year', 'month'])).map((t, n) =>
                      c.createElement(
                        f.A,
        ...
        return r.createElement(
          ...
          m &&
            r.createElement(
              ...
              r.createElement(l.m, { className: 'icon' }),
              ' ',
          ...
          y &&
            r.createElement(
              'div',
              { className: 'contact-entry' },
              r.createElement(u.w, { className: 'icon' }),
              ' ',
              r.createElement(
                'a',
                {
          ...
          b &&
            ...
            r.createElement(
              'div',
              { className: 'contact-entry' },
              r.createElement(f.D, { className: 'icon' }),
              ' ',
              r.createElement(o.Link, { to: s.A.cv }, 'Curriculum Vitae')
            ),
          h &&
            r.createElement(
              'div',
          ...
          v &&
            r.createElement(
              ...
              r.createElement(p.E, { className: 'icon' }),
              r.createElement(
                'a',
                { href: a.hy, target: '_blank', rel: 'noopener noreferrer' },
                'Dissertation'
              ),
              ' '
            ),
...
//# sourceMappingURL=component---src-pages-index-jsx-b80db29499f7439f13fd.js.map

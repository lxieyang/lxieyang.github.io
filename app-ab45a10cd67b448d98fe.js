  ...
  [524],
  {
    ...
    6017: function (t, e, n) {
          ...
          const t =
              null !==
                (o =
                  null === (a = f.attributes) ||
                  void 0 === a ||
                  null === (i = a.getNamedItem('data-original-tag')) ||
                  void 0 === i
                    ? void 0
                    : i.value) && void 0 !== o
                ? o
            ...
            if (y(t))
              if ('html' === t || 'body' === t)
                for (const n of f.attributes) {
                  if ('data-original-tag' === n.name) continue;
                ...
                if (
                  ...
                  'script' === t.nodeName.toLowerCase() && (t = v(t)),
                  d)
                )
                  if (n.has(d)) {
                    var p;
              ...
              f.attributes.getNamedItem(
                'data-gatsby-head-react-19-workaround'
              ) || h();
            f.childNodes.length &&
              r.push.apply(r, (0, c.A)(g(f, e).validHeadNodes));
          }
        }
      ...
      const w = document.createElement('div'),
        ...
        S = () => {
          var t;
          const { validHeadNodes: e, htmlAndBodyAttributes: n } = g(w);
          (E.html = Object.keys(n.html)),
            (E.body = Object.keys(n.body)),
            (function (t) {
              if (!t) return;
      ...
      function P(t) {
        return r.createElement(
          'div',
          Object.assign({ 'data-original-tag': 'html' }, t)
        );
      }
      function _(t) {
        return r.createElement(
          'div',
          Object.assign({ 'data-original-tag': 'body' }, t)
        );
      }
      const R = r.createContext(!1);
      if (18 !== parseInt(r.version.split('.')[0], 10)) {
        const t = r.createElement;
        r.createElement = function (e) {
          if ('html' === e || 'body' === e) {
            r.useContext(R) && (e = 'html' === e ? P : _);
          }
          for (
    ...
    6498: function (t, e, n) {
      ...
      const { render: T, hydrate: D } = (0, k.n)();
      ...
      const A = 'gatsby-reload-compilation-hash-match';
      (0, o.v)('onClientEntry').then(() => {
        ...
        l.Zf.loadPage(v.pathname + v.search).then((n) => {
          ...
          if (
            ...
            if (!('1' === i.getItem(A)))
              return i.setItem(A, '1'), void window.location.reload(!0);
          }
          if ((i && i.removeItem(A), !n || n.status === l.Wi.Error)) {
            const t =
              'page resources for ' +
              v.pathname +
          ...
          u &&
            u.children.length &&
            (p = (n, r) => D(n, r, { onUncaughtError: t, onCaughtError: e }));
      ...
      t.exports = [
        {
          ...
          options: {
            ...
            display: 'minimal-ui',
            icon: '/Users/lxieyang/Documents/codingSpace/lxieyang.github.io/static/pair-logo-152.png',
            legacy: !0,
...
//# sourceMappingURL=app-ab45a10cd67b448d98fe.js.map

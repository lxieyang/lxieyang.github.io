        ...
        return p.createElement(
          ...
          p.createElement(
            ...
            p.createElement(
              ...
              p.createElement('strong', null, 'human-AI interaction'),
              ' for large and multimodal language models, including tools for',
              ' ',
              p.createElement('strong', null, 'LLM evaluation'),
              ',',
              ' ',
              p.createElement('strong', null, 'controllable generation'),
              ', and',
              ' ',
              p.createElement('strong', null, 'in situ AI prototyping'),
              '. I combine human-centered research with system building, developing tools and studies that help people use AI more effectively in real workflows — from structured LLM outputs and in-the-wild mobile prototyping to personalized visual sensors, side-by-side model evaluation, accessible technology, and more.'
            ),
            p.createElement(
              U,
              null,
        ...
        return r.createElement(
          ...
          E &&
            r.createElement(
              ...
              r.createElement(o.m, { className: 'icon' }),
              ' ',
          ...
          f &&
            r.createElement(
              'div',
              { className: 'contact-entry' },
              r.createElement(m.w, { className: 'icon' }),
              ' ',
              r.createElement(
                'a',
                {
          ...
          S &&
            ...
            r.createElement(
              'div',
              { className: 'contact-entry' },
              r.createElement(u.D, { className: 'icon' }),
              ' ',
              r.createElement(a.Link, { to: c.A.cv }, 'Curriculum Vitae')
            ),
          h &&
            r.createElement(
              'div',
          ...
          b &&
            r.createElement(
              ...
              r.createElement(g.E, { className: 'icon' }),
              r.createElement(
                'a',
...
//# sourceMappingURL=component---src-pages-cv-index-jsx-dc2ad10e39f192416c9d.js.map

        ...
        return r.createElement(
          ...
          u &&
            r.createElement(
              ...
              r.createElement(i.i, { className: 'icon' }),
              ' ',
          ...
          h &&
            r.createElement(
              'div',
              { className: 'contact-entry' },
              r.createElement(o.e, { className: 'icon' }),
              ' ',
              r.createElement(
                'a',
                {
          ...
          p &&
            ...
            r.createElement(
              'div',
              { className: 'contact-entry' },
              r.createElement(s.g, { className: 'icon' }),
              ' ',
              r.createElement('a', { href: l.l5 }, 'Curriculum Vitae (PDF)')
            ),
          d &&
            r.createElement(
              'div',
          ...
          f &&
            r.createElement(
              ...
              r.createElement(m.I, { className: 'icon' }),
              r.createElement(
                'a',
                { href: l.O2, target: '_blank', rel: 'noopener noreferrer' },
                'Dissertation'
              ),
              ' '
            ),
        ...
        let { data: t } = e,
          n = [
            ...
            },
            {
              ...
              prefix: 'W',
              data: b()('publications[*type=workshop]', { data: I.E }).value,
            },
            {
              prompt: 'Patents and Defensive Publications',
              prefix: 'P',
              data: b()('publications[*type=patent]', { data: I.E }).value,
            },
          ];
        return p.createElement(
          w.Z,
          ...
          p.createElement(
            ...
            p.createElement(
              ...
              p.createElement(
                y.Z,
                { xs: '12', sm: '6' },
                p.createElement(M.Z, { data: t, inCVPage: !0, showTwitter: !1 })
              )
            ),
            p.createElement(
              z,
            ...
            p.createElement(
              ...
              n.map((e, t) =>
                p.createElement(
                  'div',
                  { key: t },
                  p.createElement(U, null, e.prompt),
            ...
            p.createElement(
              ...
              p.createElement(U, null, 'Academic Service'),
              p.createElement(
                H,
                {
                  indexSpace: 160,
              ...
              p.createElement(U, null, 'Departmental & Community Service'),
              p.createElement(
                H,
                {
                  indexSpace: 160,
...
//# sourceMappingURL=component---src-pages-cv-index-jsx-01bb2094541ace7995c9.js.map
